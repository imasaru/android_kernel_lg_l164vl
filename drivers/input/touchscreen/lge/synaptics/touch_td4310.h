...
/*----Should only be enabled to change from UI mode -> uBL mode----*/
/*  for  -> DEBUGGING PURPOSE  -> $F35 F/W Recovery Check*/
#if 1
#define ENTER_MICROBL_MODE
#endif
...
// F54_ANALOG_CTRL99 (Integration Duration) - AMP Open
...
#define F35_ERASE_ALL_WAIT_MS 		5000 // [bringup] 2000
